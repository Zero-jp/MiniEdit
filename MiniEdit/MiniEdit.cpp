...
// MiniEdit.cpp: определяет поведение классов для приложения.
//
...
// Единственный объект CMiniEditApp

CMiniEditApp theApp;


// Инициализация CMiniEditApp
...
// Обработчики сообщений CMiniEditApp
...
// Методы загрузки или сохранения настроек CMiniEditApp
